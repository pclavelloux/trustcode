        ...
        {currentUser ? (
          <>
            <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-400 italic">GitHub Contributor</div>
            </div>
            <MenuItems as="ul" className="focus:outline-hidden">
              ...
              <MenuItem as="li">
                <button onClick={handleSignOut} className="font-medium text-sm flex items-center py-1 px-3 text-violet-500 w-full text-left">
                  Sign Out
                </button>
              </MenuItem>
            </MenuItems>
          ...
          <MenuItems as="ul" className="focus:outline-hidden">
            <MenuItem as="li">
              <Link className="font-medium text-sm flex items-center py-1 px-3 text-violet-500" href="/login">
                Sign In
              </Link>
            </MenuItem>
          </MenuItems>
